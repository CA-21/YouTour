...
public class MytourFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        TabHost.OnTabChangeListener tabChangeListener = new TabHost.OnTabChangeListener() {
            ...
            public void onTabChanged(String tabId) {
                ...
                downloadFragment = (MytourTabDownload) fm.findFragmentByTag("download");
                cloudFragment = (MytourTabCloud) fm.findFragmentByTag("cloud");
                favoriteFragment = (MytourTabFavorite) fm.findFragmentByTag("favorite");
            ...
            private void isTabDownload() {
                if (downloadFragment == null) {
                    ft.add(R.id.realtabcontent, new MytourTabDownload(), "download");
                } else {
            ...
            private void isTabFavorite() {
                if (favoriteFragment == null) {
                    ft.add(R.id.realtabcontent, new MytourTabFavorite(), "favorite");
                } else {
    ...
    private void findTabView(View v) {
        ...
        tabIndicator1 = (LinearLayout) LayoutInflater.from(v.getContext()).inflate(R.layout.tourtab_indicator, tw,
                false);
        ...
        tabIndicator2 = (LinearLayout) LayoutInflater.from(v.getContext()).inflate(R.layout.tourtab_indicator, tw,
                false);
        ...
        tabIndicator3 = (LinearLayout) LayoutInflater.from(v.getContext()).inflate(R.layout.tourtab_indicator, tw,
                false);
